class Condition
    ...
    def self.getResult(condition, total, quantity_product_size)
        ...
        if (condition["is_primitive"])
            ...
            self.getConditionResult(condition["operator"], getResult(condition["condition1"], total, quantity_product_size), getResult(condition["condition2"], total, quantity_product_size))
        end
    end
